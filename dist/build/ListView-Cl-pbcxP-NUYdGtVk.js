import{u as A,h as oe,a4 as ge,g9 as j,ga as fe,eB as J,gb as xe,j as e,F as x,U as S,aG as N,a0 as ye,D as se,E as ie,aU as be,L as ae,r as L,B as m,d as h,a5 as je,n as Ce,dx as we,w as G,x as X,y as P,z as Z,T as f,A as _,C as Q,bq as Y,br as ee,aK as Te,I as te,aJ as ve,by as $e,bj as ke}from"./strapi-ClN9_dxO.js";import{u as D,a as re,g as u,A as Me,C as ne}from"./index-Knq4Ti8R-DJQ5FAQF.js";import"./sortBy-BTL4HUvw.js";import"./groupBy-2lAig-HW.js";import"./_baseEach-C5OkAOQ6.js";import"./index-DJHCk64l.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";import"./_baseMap-BpFKqF2v.js";const Fe=h(m)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,De=({component:t,dzName:n,index:o,isActive:s=!1,isInDevelopmentMode:r=!1,onClick:i})=>{const{modifiedData:p,removeComponentFromDynamicZone:b}=D(),{schema:{icon:y,displayName:g}}=j(p,["components",t],{schema:{}}),l=a=>{a.stopPropagation(),b(n,o)};return e.jsxs(Ae,{alignItems:"center",direction:"column",className:s?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:i,role:"tab",tabIndex:s?0:-1,cursor:"pointer","aria-selected":s,"aria-controls":`dz-${n}-panel-${o}`,id:`dz-${n}-tab-${o}`,children:[e.jsx(Ie,{icon:y,isActive:s}),e.jsx(m,{marginTop:1,maxWidth:"100%",children:e.jsx(f,{variant:"pi",fontWeight:"bold",ellipsis:!0,children:g})}),r&&e.jsx(ce,{tag:"button",onClick:l,children:e.jsx(ke,{})})]})},Re=h(N)`
  width: 3.2rem;
  height: 3.2rem;
  padding: 0.9rem;
